 ...
 * 		setGlobalFont함수
 */
public class NMapBaseActivity extends NMapActivity {
...
//		setDeviceId();
	...
	public void setContentView(int layoutResID) {
		if (NMapBaseActivity.mTypeface == null && hasCustomFontFile)
			NMapBaseActivity.mTypeface = Typeface.createFromAsset(getAssets(), mFontFileName);
